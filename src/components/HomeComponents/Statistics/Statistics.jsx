  ...
  return (
    <Section>
      ...
      <p className={styles.textWrapper}>
        We are proud to share the significant results we have achieved thanks to
        your unwavering support and compassion. This week alone, we&apos;ve
        ...
        <br /> assist with adoptions, and provide emotional comfort to those who
        have suffered neglect or abuse.
        <br /> In addition to this, we are proud to collaborate with 78 trusted
